          ...
          <div className="cta bg-linear-to-r from-[#e8e4ff] via-[#ddd8ff] to-[#e8e4ff] bg-size-[200%] animate-[gradShift_7s_ease_infinite] border border-[rgba(124,58,237,0.25)] rounded-[20px] p-12 flex items-center gap-10 flex-wrap relative overflow-hidden shadow-2xl">
            <div className="flex-1 min-w-65 relative">
              ...
              <p className="text-base text-[rgba(26,10,46,0.65)] leading-relaxed">
                Reach 2 million+ active buyers and renters. Get genuine, verified leads — no hidden charges, no middlemen.
              </p>
            </div>
            <div className="flex gap-3 flex-wrap relative">
              <button className="btn-p px-6 py-3 bg-white text-[#7c3aed] rounded-[10px] font-bold shadow-md hover:-translate-y-0.5 hover:shadow-xl transition">
                Post Property Free
              </button>
              <button className="btn-ghost px-6 py-3 bg-[rgba(124,58,237,0.06)] border border-[rgba(124,58,237,0.3)] rounded-[10px] text-[#1a0a2e] font-semibold hover:bg-[rgba(124,58,237,0.12)] transition">
                Agent Dashboard →
              </button>
            </div>
          </div>
